...
export default function JobCard({ newF, featured, company, logo, position, postedAt, contract, location, rol, level, language, tools, onFilterChange, filters }) {
    ...
    return (
        <div className="relative bg-white mx-6 border-l-[6px] border-bgCyan rounded-xl px-5 shadow-xl flex flex-col gap-3 pb-3 sm:flex-row sm:items-center pt-4 sm:m-auto sm:max-w-[1200px]">
